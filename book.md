...
<mark style="color:green;">**- BD681 2개 구성 (BD681 + BD682 + BD681)**</mark>

![](../_assets/09.BD681_2개_케이블_연결.png)<br>
그림 8 BD681 2개 케이블 연결
...
보드 스위치에 대한 세부 내용은 "[2.1 보드 스위치 확인](./1-Board-Switch-Setting.md)" 매뉴얼을 참고하시기 바랍니다.
...
![](../_assets/10.BD681_2개_EtherCAT_네트워크_모니터링.png)<br>
그림 9 BD681 2개 EtherCAT 네트워크 모니터링<br><br>

![](../_assets/11.BD681_2개_사용자DIO_보드_설정.png)<br>
그림 10 BD681 2개 사용자DIO 보드 설정<br>

BD681 보드의 상태표시 LED는 정상적으로 연결 될 경우, 'BD681 1개 구성'의 'BD681 보드 상태표시 LED 동작' 과 동일하게 동작합니다.# 2.3. FB 블럭 설정

FB 블럭 설정은 다음 메뉴에서 진행할 수 있습니다.

**- 메뉴 위치1: [시스템] - [2:제어 파라미터] - [11:산업용 통신] - [6:fb블럭 할당]**<br>
**- 메뉴 위치2: [시스템] - [2:제어 파라미터] - [2:입출력 신호 설정] - [6:fb블럭 할당]**

![](../_assets/12.FB블럭할당.png)<br>
그림 11 FB 블럭 할당 메뉴<br><br>

할당하고 싶은 fb 블럭을 선택하여 '사용자 DIO'로 설정을 진행하면 됩니다.

![](../_assets/13.fb1_사용자DIO할당.png)<br>
그림 12 fb1에 사용자DIO 할당 예시<br><br>
...
그림 13 사용자DIO FB블록 미할당<br><br>

![](../_assets/15.사용자DIO_FB3_할당.png)<br>
그림 13 사용자DIO fb3 할당<br>
...
그림 15 래더 로직의 fb1 논리적/물리적 입출력 연결 예시<br>
...
그림 21 연결 오류시 디지털 출력 설정<br>

<br>

**표 4 연결 오류시 디지털 출력 설정 정보**
