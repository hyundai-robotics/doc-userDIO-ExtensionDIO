...
* [3. 사용자 DIO, 확장 DIO 설정 방법](3-Configuration/README.md)
  * [3.1. EtherCAT 설정](3-Configuration/1-EtherCAT-Configuration.md)
  * [3.2. 보드 스위치 확인](3-Configuration/2-Board-Switch-check.md)
  * [3.3. FB 블럭 설정](3-Configuration/3-FB-Block-Configuration.md)
  * [3.4. 내장 PLC 설정 확인](3-Configuration/4-Internal-PLC-Configuration.md)
  * [3.5. 센서 동기 설정](3-Configuration/5-Sensor-Sync-Configuration.md)
  
* [4. 사용자 DIO, 확장 DIO 사용 방법](4-Usage/README.md)
  * [4.1. DIO 사용 방법](4-Usage/1-DIO-Usage.md)
  * [4.2. 컨베이어 인터페이스 사용 방법](4-Usage/2-Conveyor-Usage.md)
