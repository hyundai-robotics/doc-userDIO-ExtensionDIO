...
BD681, BD682의 DIO를 사용하기 위해서는 우선 "[하드웨어 정보](https://hrbook-hrc.web.app/#/view/doc-hi6a-n-maintenance/korean/5-optional-components/5-UserDIO/2-HW-Inform)" 매뉴얼을 참고하여 BD681, BD682의 커넥터에 올바르게 입출력 배선을 연결합니다.
